...
const SOURCE_FILE = path.join(ROOT_DIR, "seeds", "movie-recommendation", "generated", "movie_tags_seed.csv")
const OUTPUT_DIR = path.join(ROOT_DIR, "seeds", "recommendation-chat")
