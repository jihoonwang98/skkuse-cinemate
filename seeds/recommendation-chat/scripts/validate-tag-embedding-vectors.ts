...
const SOURCE_FILE = path.join(ROOT_DIR, "seeds", "recommendation-chat", "movie-tag-embeddings.jsonl")
const VECTOR_FILE = path.join(ROOT_DIR, "seeds", "recommendation-chat", "movie-tag-embeddings-with-vectors.jsonl")
