...
const OUTPUT_FILE = path.join(ROOT_DIR, "seeds", "recommendation-chat", "analysis-smoke-report.json")
const SUMMARY_OUTPUT_FILE = path.join(ROOT_DIR, "seeds", "recommendation-chat", "analysis-smoke-summary.md")
